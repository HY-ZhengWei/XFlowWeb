...
<body>
	...
	<svg width="2000" height="600px" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
var v_BL        = (v_Schedules.length <= 9 ? 80 : (v_Schedules.length <= 11 ? 30 : 20));
var b           = {w:90 ,h:51 ,s:3 ,t:10 ,l:v_BL ,top:240};
...
{
    return "translate(" + (i * (b.w + b.s) + b.l ) + "," + b.top + ")";
});
...
v_SVG.selectAll("g").data(v_Schedules).each(function(d ,i)
{
	...
	.on("mouseenter" ,function() 
	{
		...
		{
			if ( v_OldData == null || d.mainTask != v_OldData.mainTask )
			{
				v_OldData = d;
	...
	if ( 0 <= d.finishPercentage && d.finishPercentage < 100 )
	{
		setTimeout(function()
		{ 
			v_OldData = d;
	...
	else if ( d.finishPercentage >= 100 )
	{
		setTimeout(function()
		{ 
			v_OldData = d;
